...
int main(int argc, char **argv)
{
    ...
    srand(time(NULL));
    ros::NodeHandle n;
    ros::Publisher chatter_pub = n.advertise<anro1::point>("nodes_info", 1);//utworzenie kanalu do nadawania
    //ros::Publisher route_chatter = n.advertise<anro1::routemsg>("routes_info", 1);//utworzenie kanalu do nadawania
   ...
   // ros::Subscriber sub = n.subscribe("map_crossroad_info", 1, process);//subskrypcja kanalu z informacjami
    ...
    time(&lasttick);
   vector<InSide> inside = createPoints(1,1,1,1);
